...
class SurveyPoint:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Survey Point')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SurveyPoint', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SurveyPoint/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Create Survey Points'),
            callback=self.run,
